...
import 'package:my_app/pages/user/views/guestbook_view.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
      name: AppRoutes.guestbook,
      page: () {
        final args = Get.arguments as Map<String, dynamic>? ?? {};
        final residentName = args['residentName'] as String? ?? '주민';
        return GuestbookScreen(residentName: residentName);
      },
      transition: Transition.rightToLeft,
    ),
  ];
