...
import 'village_invitation_screen.dart';

class InvitationInputScreen extends StatefulWidget {
  const InvitationInputScreen({super.key});

  @override
  State<InvitationInputScreen> createState() => _InvitationInputScreenState();
}

class _InvitationInputScreenState extends State<InvitationInputScreen> {
    ...
    try {
      ...
      if (mounted) {
        ...
        final result = await Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => VillageInvitationScreen(
              invitationCode: code,
            ),
          ),
        );
