  ...
  void _openCategory(BuildContext context, String category) {
    if (category == '주민집') {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (_) =>
              ResidentProfileScreen(villageName: widget.villageName),
        ),
      );
    ...
    // -----------------------------------------------------------
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('$category 페이지로 이동')));
    }
  }
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Center(
                        child: Text('뒤로가기', style: TextStyle(fontSize: 14)),
                      ),
                    ),
                  ),
                  Text(
                    ...
                    onTap: () {
                      if (_currentUserRole?.isCreator != true) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('마을 생성자만 접근 가능')),
                        );
                        return;
                      }
